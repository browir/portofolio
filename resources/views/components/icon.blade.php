...
@php
    $inner = match ($name) {
        ...
        'sound-on' => '<path d="M4 9.5h3.5L12 5.5v13L7.5 14.5H4Z"/><path d="M15.5 8.5a5 5 0 0 1 0 7M18 6a8.5 8.5 0 0 1 0 12"/>',

        'sound-off' => '<path d="M4 9.5h3.5L12 5.5v13L7.5 14.5H4Z"/><path d="M15.5 9.5 20 14M20 9.5l-4.5 4.5"/>',
