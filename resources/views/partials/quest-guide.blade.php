...
<div id="quest-guide" class="quest-guide" hidden>
    <div class="quest-npc-figure">
        <x-character-icon name="wira" class="h-auto w-full" />
    </div>

    <div class="quest-npc-bubble">
        <div class="quest-guide-head">
            <span class="quest-npc-name font-display js-npc-name">WIRA</span>
        ...
        <p class="quest-npc-line font-body js-npc-line">&ldquo;Selamat datang, Player.&rdquo;</p>
